...
// v1 = v3 (updated 2026-05-27) — adds social-mission framing + customization promise
// v2 = open/lighter (use when accept came after 3+ days)
// See: ~/.claude/projects/.../memory/feedback_lotan_v3_template.md
...
מקווה שהשגרה הזמנית (בתקווה קבועה)  עושה טוב!
...
יקב טוליפ הינו עסק חברתי המעסיק אנשים בעלי מוגבלויות וממוקם בכפר תקוה (הכפר הראשון בעולם שהוקם למען אנשים עם צרכים מיוחדים וכל תושביו כאלו). המארזים הקהילתיים שלנו משלבים יינות זוכי פרסים, איכותיים ומרגשים.



חשוב לציין שאנחנו בונים ומרכיבים מארזים לפי התקציב והצרכים שלך ושל הארגון שלך.
